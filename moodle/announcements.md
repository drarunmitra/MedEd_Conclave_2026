...
> participant who arrives ready and one who does not is roughly the whole first
> session.
>
...
> there so the work does not all land on 8 September.
>
> **If your institution restricts software installation on your laptop, reply
> now** rather than in September. There is a cloud fallback, but it takes us a few
> days to arrange and a local install is much better for your work afterwards.
>
> Stuck on anything: post in the help desk forum in Section 1. Faculty read it
> daily.
>
> The SET Team
...
> worked through Primer 5 arrive recognising a plot they have already drawn.
> Participants who have not, meet `ggplot(students, aes(x = attendance_pct))`
...
> Dear all,
>
> Nine days to go. **This week's target is Section 3**: download the four
> datasets into your project's `data/` folder, and skim the pre-reading. Both
...
> read a failure on Saturday than diagnose it in a full room on Wednesday.
>
...
>
> Still stuck? Post in the help desk forum today, or reply to this with (a) your
> operating system, (b) the exact error, and (c) the full setup-check output. We
> will sort it out before Wednesday.
>
