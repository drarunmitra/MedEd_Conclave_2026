...
This page runs R inside your browser. It needs about 15 MB on first load — the
...
#| exercise: ex_vector
#| check: true
if (identical(.result, c(78, 70, 91, 55, 83))) {
  ...
  list(correct = FALSE, message = "Use c() to combine the five marks: c(78, 70, ...).")
}
```
...
if (identical(as.numeric(.result), 4)) {
  list(correct = TRUE, message = "Correct — four marks are 70 or above.")
